...
Oxygen &mdash; recall from the Needs chapter that humans require on average about 550 liters (0.55 cubic meters) of pure oxygen per day. With roughly 7.5 Billion people on the planet, that means we need over 4 Billion cubic meters/day. The Earth&apos;s troposphere contains about 600 Million cubic kilometers of oxygen, or 6\*10^17 cubic meters {{"UCAR" | cite}}. Ignoring all other effects for a moment, the troposphere contains enough oxygen for about 1.5\*10^8 days of human breathing, which more than 400,000 years {{"NASA2" | cite}}.
